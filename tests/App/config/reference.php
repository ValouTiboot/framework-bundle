 ...
 *     },
 * }
 * @psalm-type DigitixFrameworkConfig = array{
 *     entity_namespaces?: list<scalar|Param|null>,
 *     controller_namespaces?: list<scalar|Param|null>,
 *     admin_menu?: array<string, array{ // Default: []
 *         title?: scalar|Param|null, // Default: "Entity title"
 *         route?: scalar|Param|null, // Default: "dgtx_admin_entity_read"
 *         icon?: scalar|Param|null, // Default: "home"
 *         sub?: array<string, array{ // Default: []
 *             title?: scalar|Param|null, // Default: "Entity title"
 *             route?: scalar|Param|null, // Default: "dgtx_admin_entity_read"
 *         }>,
 *     }>,
 *     admin_entities?: array<string, array{ // Default: []
 *         class?: scalar|Param|null, // Doctrine entity class. Defaults to the first "<entity_namespaces>\{Name}" that exists; null means a virtual entity. // Default: null
 *         controller?: scalar|Param|null, // Controller class (must extend the bundle AdminController). Defaults to a class found by convention, then to the generic controller. // Default: null
 *         view?: array{
 *             template?: scalar|Param|null, // Default: null
 *         },
 *         list?: array{
 *             template?: scalar|Param|null, // Default: null
 *             has_create?: bool|Param, // Default: false
 *             sortable?: bool|Param, // Default: false
 *             items_per_page?: int|Param, // Default: 30
 *             toolbar?: list<scalar|Param|null>,
 *             actions?: list<scalar|Param|null>,
 *             header_link?: mixed, // Default: []
 *             fields?: array<string, array{ // Default: []
 *                 label?: scalar|Param|null,
 *                 name?: scalar|Param|null, // Entity property (defaults to the key).
 *                 type?: scalar|Param|null, // Default: "text"
 *                 required?: bool|Param,
 *                 disabled?: bool|Param,
 *                 help?: scalar|Param|null,
 *                 sort?: bool|Param,
 *                 default_sort?: "asc"|"desc"|"ASC"|"DESC"|Param,
 *                 column?: scalar|Param|null, // Property displayed for "entity" list columns.
 *                 callback?: scalar|Param|null, // Static callable returning choices, e.g. "App\Foo::choices".
 *                 collectionType?: scalar|Param|null,
 *                 rows?: int|Param,
 *                 class?: scalar|Param|null, // CSS class(es) added to the widget.
 *                 attr?: mixed,
 *                 choice?: mixed,
 *                 collection?: array{
 *                     name?: scalar|Param|null,
 ...
 *                 label?: scalar|Param|null,
 *                 type?: scalar|Param|null, // Default: "text"
 *                 alias?: scalar|Param|null, // DQL alias: "a" (entity) or "t" (translation). Guessed when omitted.
 ...
 *         form?: array{
 *             template?: scalar|Param|null, // Default: null
 *             has_return_link?: bool|Param, // Default: true
 *             has_auto_submit_button?: bool|Param, // Default: true
 *             translation_domain?: scalar|Param|null, // Default: "Admin.Fields.Label"
 *             fields?: array<string, array{ // Default: []
 *                 label?: scalar|Param|null,
 *                 name?: scalar|Param|null, // Entity property (defaults to the key).
 *                 type?: scalar|Param|null, // Default: "text"
 ...
 *         },
 *     }>,
 *     front_entities?: array<string, array{ // Default: []
 *         form?: array{
 *             template?: scalar|Param|null, // Default: null
 *             has_return_link?: bool|Param, // Default: true
 *             has_auto_submit_button?: bool|Param, // Default: true
 ...
 *     digitix_framework?: DigitixFrameworkConfig,
 *     "when@test"?: array{
 *         imports?: ImportsConfig,
 *         parameters?: ParametersConfig,
 *         services?: ServicesConfig,
